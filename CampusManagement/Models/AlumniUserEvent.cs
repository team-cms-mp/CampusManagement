...
namespace CampusManagement.Models
{
    ...
    public partial class AlumniUserEvent
    {
    ...
    public class AlumniUserEventViewModel
    {
        public List<AlumniUserEvent> AlumniUserEvents { get; set; }
        public AlumniUserEvent SelectedAlumniUserEvents { get; set; }
