<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewerBatchProgramFormSearch.aspx.cs" Inherits="CampusManagement.Reporting.ReportForms.ReportViewerBatchProgramFormSearch" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <input id="FormNoNew" class="form-control" runat="server" />
                </td>
                <td style="text-align: right;">
                    <label class="control-label">Department</label>
                </td>
                <td>
                    <select id="cmbSubDepartmentNew" class="form-control" runat="server"></select>
                </td>
                <td style="text-align: right;">
