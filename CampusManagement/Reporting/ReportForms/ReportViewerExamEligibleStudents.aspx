<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewerExamEligibleStudents.aspx.cs" Inherits="CampusManagement.Reporting.ReportForms.ReportViewerExamEligibleStudents" %>
            ...
            <ContentTemplate>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <label class="control-label">Eligible</label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlEligible" runat="server" class="form-control">
                            </asp:DropDownList>
                        </td>
                        <td style="text-align: right;">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlBatch" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td style="text-align: right;">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlProgram" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
