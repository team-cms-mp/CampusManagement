<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewerBatchIDSearch.aspx.cs" Inherits="CampusManagement.Reporting.ReportForms.ReportViewerBatchIDSearch" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 50%;">
            <tr>
                ...
                <td>
                    <select id="cmbBatch" class="form-control" runat="server"></select>
                </td>
            </tr>
            <tr>
                <td></td>
