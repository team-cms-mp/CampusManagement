<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewerBatchProgramTestAndNTSSearch.aspx.cs" Inherits="CampusManagement.Reporting.ReportForms.ReportViewerBatchProgramTestAndNTSSearch" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <select id="cmbDegreeID" class="form-control" runat="server"></select>
                </td>
            </tr>
            <tr>
                <td></td>
