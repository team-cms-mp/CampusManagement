...
{
    public class ExamStudentSubjectClashReportController : Controller
    {
        private ModelCMSNewContainer db = new ModelCMSNewContainer();
        ExamStudentSubjectClashReportViewModel model = new ExamStudentSubjectClashReportViewModel();
        // GET: ExamStudentSubjectClashReport
        ...
        [HttpPost]
        public ActionResult Index(ExamStudentSubjectClashReportViewModel ESSR)
        {
