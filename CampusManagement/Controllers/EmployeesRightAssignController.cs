...
{
    [Authorize]
    public class EmployeesRightAssignController : Controller
    {
        private ModelCMSNewContainer db = new ModelCMSNewContainer();
        EmployeePagesForRightViewModel model = new EmployeePagesForRightViewModel();
        ...
        public ActionResult AssignPages(int EmpID, string EmployeeName)
        {
            ...
            model.EmployesPagesList = db.GetEmployeePagesForRight(EmpID).ToList();
            return View(model);
        }
