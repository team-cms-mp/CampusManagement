...
{
    [Authorize]
    public class ApplicantUploadsController : Controller
    {
        int count = 0;
        string ErrorMessage = "";
        ...
        public ActionResult Index(string FormNo)
        {
            ...
            if (EmpID != 0)
            {
                ...
                {
                    Applicant ap = db.Applicants.FirstOrDefault(a => a.CreatedBy == EmpID);
                    if (ap != null)
                    {
                        FormNo = ap.FormNo;
                    }
        ...
        public ActionResult Create(ApplicantUpload ApplicantUpload, string FormNo)
        {
            ...
            if (ApplicantUpload.DocumentName == null)
            {
        ...
        public ActionResult ApplicantUploadSearch(string formNo)
        {
            return View(db.GetApplicantUploadDetails(formNo).ToList());
        }
