...
namespace CampusManagement.Controllers
{
    ...
    public class StudentServicesController : Controller
    {
        ...
        public ActionResult StudentServicesApproval()
        {
            ...
            {
                List<SF_GetStudentServiceDetail_Result> lstServices = db.SF_GetStudentServiceDetail(0, 0, 1007, 0, 0).ToList();
        ...
        public ActionResult StudentServicesApproval(int? BatchID, int? BatchProgramID, int? YearSemesterNo)
        {
            ...
            else
            {
                ...
                List<SF_GetStudentServiceDetail_Result> lstServices = db.SF_GetStudentServiceDetail(BatchProgramID, YearSemesterNo, 1007, 0, 0).ToList();
                return View(lstServices);
            }
        }
        ...
        public ActionResult ApproveStudentServicesApproval(int? hdnBatchProgramID, int? hdnYearSemesterNo)
        {
            ...
            else
            {
                ...
                db.SF_UpdateStudentServiceStatus(hdnBatchProgramID, hdnYearSemesterNo, 1007, 0, EmpID, 0, 0, 3009);
            }
        ...
        public ActionResult StudentServicesApproved()
        {
            ...
            {
                List<SF_GetStudentServiceDetail_Result> lstServices = db.SF_GetStudentServiceDetail(0, 0, 3009, 0, 0).ToList();
                return View(lstServices);
            }
        }
        ...
        public ActionResult StudentServicesApproved(int? BatchID, int? BatchProgramID, int? YearSemesterNo)
        {
            ...
            else
            {
                ...
                List<SF_GetStudentServiceDetail_Result> lstServices = db.SF_GetStudentServiceDetail(BatchProgramID, YearSemesterNo, 3009, 0, 0).ToList();
                return View(lstServices);
            }
        }
        ...
        public ActionResult SingleStudentServicesApproval(int? StudentID)
        {
            ...
            {
                List<SF_GetStudentServiceDetail_Result> lstServices = db.SF_GetStudentServiceDetail(0, 0, 0, StudentID, 0).ToList();
                return View(lstServices);
            }
        }
            ...
            else
            {
                ...
                if (string.IsNullOrEmpty(error))
                {
                    db.SF_GenerateStudentServiceChallans(hdnBatchProgramID, hdnYearSemesterNo, Convert.ToDateTime(IssueDate)
                        , Convert.ToDateTime(LastDate), AccountID, EmpID, 0, 0);
        ...
        {
            model.GetStudentServicesAccumulate_Results = db.GetStudentServicesAccumulate(0, "", 1, "Student", 0).ToList();
        ...
        public ActionResult Search(Challan challan)
        {
            ...
            model.GetStudentServicesAccumulate_Results = db.GetStudentServicesAccumulate(challan.BatchProgramID, "", 1, "Student", 0).ToList();
            model.SelectedGetStudentServicesAccumulate_Result = null;
            model.DisplayMode = "WriteOnly";
     ...
     , int? hdnBatchID, int? hdnBatchProgramID, int? hdnYearSemesterNo, FormCollection fc)
                ...
                if (string.IsNullOrEmpty(error))
                {
                    for (int i = 1; i <= hdnCount; i++)
                    {
                        ...
                        if (chkGenerateChallan == "Yes")
                        {
                            ...
                            db.SF_GenerateStudentServiceChallans(hdnBatchProgramID, hdnYearSemesterNo, Convert.ToDateTime(IssueDate)
                                , Convert.ToDateTime(LastDate), AccountID, EmpID, 0, StudentID);
        ...
        {
            model.GetStudentServicesAccumulate_Results = db.GetStudentServicesAccumulate(0, "", 1, "StudentStatus", 4013).ToList();
            model.SelectedGetStudentServicesAccumulate_Result = null;
            model.DisplayMode = "WriteOnly";
            ViewBag.BatchID = new SelectList(db.Batches, "BatchID", "BatchName");
            ViewBag.BatchProgramID = new SelectList(db.GetBatchProgramNameConcat("", 0), "ID", "Name");
        ...
        public ActionResult StudentServicesAccumulateGeneratedSearch(Challan challan)
        {
            ...
            model.GetStudentServicesAccumulate_Results = db.GetStudentServicesAccumulate(challan.BatchProgramID, "", 1, "StudentStatus", 4013).ToList();
            model.SelectedGetStudentServicesAccumulate_Result = null;
            model.DisplayMode = "WriteOnly";
            ViewBag.BatchID = new SelectList(db.Batches, "BatchID", "BatchName", challan.BatchID);
            ViewBag.BatchProgramID = new SelectList(db.GetBatchProgramNameConcat("", 0), "ID", "Name", challan.BatchProgramID);
